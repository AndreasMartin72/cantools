...
#include <dmalloc.h>
#endif
#define MDF_CREATE(type,obj) type *(obj) = (type *)mdf_calloc(1, sizeof(type))
#define MDF_FREE(ptr) mdf_free(ptr)
...
typedef struct {
  ...
  /* 006 */ real_t      value_min                ATTRIBUTE_PACKED;
  /* 014 */ real_t      value_max                ATTRIBUTE_PACKED;
...
typedef struct {
  ...
  /* 026 */ mdf_char32_t    signal_name;
  /* 058 */ mdf_char128_t   signal_description;
...
typedef struct {
  ...
  union {
    struct { /* type 2 */
      ...
      uint32_t      address                         ATTRIBUTE_PACKED;
      mdf_char80_t  description;
      mdf_char32_t  ecu_identification;
    } dim;
    struct { /* type 19 */
      uint32_t      can_id                          ATTRIBUTE_PACKED;
      uint32_t      can_channel                     ATTRIBUTE_PACKED;
      mdf_char36_t  message_name;
      mdf_char36_t  sender_name;
    } vector_can;
  } supplement;
} ce_block_t;
